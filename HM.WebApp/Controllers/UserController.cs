        ...
        public ActionResult GetUserInfo(int userId)
        {
            ...
            if (user != null)
            {
                var obj = new
                {
                    ...
                    user.Inactive,
                    user.ModifiedBy,
                    ModifiedOn = user.ModifiedOn?.ToLocalTime().ToString(DateTimeUtils.YYYY_MM_DD_HH_MM) ?? string.Empty,
                    user.CreatedBy,
                    CreatedOn = user.CreatedOn.ToLocalTime().ToString(DateTimeUtils.YYYY_MM_DD_HH_MM),
                    user.Fullname,
                    user.Password,
                    user.Username,
                    user.RoleId,
